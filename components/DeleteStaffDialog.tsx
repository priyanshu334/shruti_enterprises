  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-md text-center">
        <DialogHeader>
          <DialogTitle className="text-lg font-semibold">Delete Staff</DialogTitle>
        </DialogHeader>
        ...
        <p className="text-sm text-gray-600 px-6">
          Deleting this staff will remove all associated data. Are you sure you want to proceed?
        </p>
